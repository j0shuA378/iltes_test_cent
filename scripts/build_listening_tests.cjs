...
const tests = [
  ...
  // ==========================================
  {
    ...
    sections: [
      ...
      },
      {
        ...
        transcript: [
          { speaker: 'Ranger', text: 'Good morning visitors, and welcome to Highclere Eco-Heritage Park. The reserve encompasses 400 hectares of restored wetland and ancient woodland.' },
          { speaker: 'Ranger', text: 'To your left is the Heron Sanctuary, where over 30 avian species breed. Binoculars can be hired from the visitor reception for £4 per session.' },
          { speaker: 'Ranger', text: 'Please bear in mind that the Red Squirrel Boardwalk will be closed between 13:00 and 15:00 today for timber maintenance.' },
          { speaker: 'Ranger', text: 'For those interested in historical flora, our Victorian Walled Garden features a rare collection of medicinal herbs dating back to 1870.' },
          { speaker: 'Ranger', text: 'Finally, our Organic Orchard Café serves fair-trade refreshments and artisan bakery items from 10:00 to 17:30 daily.' }
        ],
        questions: [
          {
            id: 6,
      ...
      },
      {
        ...
        transcript: [
          { speaker: 'Dr. Evans', text: 'Good afternoon Maya, Aaron. Come in. Let us review your proposal on decommissioned wind turbine blades.' },
          { speaker: 'Maya', text: 'Thank you Dr. Evans. As you know, while wind turbines generate clean power, their blades are made of fiberglass and thermoset epoxy resin, which cannot be melted down easily.' },
          { speaker: 'Aaron', text: 'Our literature review indicates that roughly 43 million metric tonnes of blade waste will accumulate globally by 2050 if pyrolysis recycling is not scaled up.' },
          { speaker: 'Dr. Evans', text: 'That is a staggering figure. What specific thermal decomposition temperature range are you modeling in your lab simulation?' },
          { speaker: 'Maya', text: 'We are evaluating fluidized-bed pyrolysis operating between 450 and 550 degrees Celsius to recover structural glass fibers.' },
          { speaker: 'Dr. Evans', text: 'Excellent. Make sure you compare the tensile strength of the recycled fibers against virgin glass fibers in chapter four.' },
          { speaker: 'Aaron', text: 'Yes, our laboratory tensile tests show recycled fibers retain approximately 85 percent of their original structural rigidity.' },
          { speaker: 'Dr. Evans', text: 'That is quite promising. Don\'t forget to submit your lab safety clearance form by this Friday.' }
        ],
        questions: [
          {
            id: 11,
      ...
      },
      {
        ...
        transcript: [
          { speaker: 'Lecturer', text: 'Good morning everyone. Today we examine temperate coastal ecosystems dominated by giant kelp, known scientifically as Macrocystis pyrifera.' },
          { speaker: 'Lecturer', text: 'Under ideal conditions of nutrient-rich upwelling and sunlight, giant kelp can grow at an astonishing rate of up to 50 centimeters per day.' },
          { speaker: 'Lecturer', text: 'The plant anchors itself to rocky seabeds using a specialized root-like structure called a holdfast, while gas-filled pneumatocysts keep the photosynthetic fronds afloat near the surface.' },
          { speaker: 'Lecturer', text: 'Recent oceanographic tracking reveals that when kelp dislodges during winter storms, roughly 11 percent of the organic carbon is transported into deep submarine canyons.' },
          { speaker: 'Lecturer', text: 'Once deposited below 1,000 meters, this carbon remains sequestered from the atmosphere for centuries, making kelp forests an indispensable blue carbon sink.' }
        ],
        questions: [
          {
            id: 16,
  ...
  // ==========================================
  {
    ...
    sections: [
      ...
      },
      {
        ...
        transcript: [
          { speaker: 'Audio Guide', text: 'Welcome to the Royal Botanic Conservatory. Before entering the Tropical Zone, please ensure your mobile phones are on silent.' },
          { speaker: 'Audio Guide', text: 'The Tropical House maintains a permanent humidity of 80 percent and a temperature of 26 degrees Celsius to simulate Amazonian rainforest conditions.' },
          { speaker: 'Audio Guide', text: 'In Zone 2, our Alpine Glasshouse features specialized subterranean chilling pipes that cool the soil down to 4 degrees at night.' },
          { speaker: 'Audio Guide', text: 'The outdoor Treetop Canopy Walkway stands 18 metres above the forest floor, offering panoramic views of ancient oak groves.' },
          { speaker: 'Audio Guide', text: 'Wheelchair access is available via the southern ramp, and guided expert talks depart from the central courtyard every hour on the half-hour.' }
        ],
        questions: [
          {
            id: 6,
      ...
      },
      {
        ...
        transcript: [
          { speaker: 'Prof. Lin', text: 'Good afternoon Clara, David. Let us review the progress on your biopolymer packaging project.' },
          { speaker: 'Clara', text: 'Thank you Professor Lin. We synthesized thin biodegradable transparent film using chitosan derived from discarded shrimp shells.' },
          { speaker: 'David', text: 'We blended the chitosan matrix with thyme essential oil to boost its antifungal properties against foodborne pathogens.' },
          { speaker: 'Prof. Lin', text: 'How did you assess the gas barrier properties of your film?' },
          { speaker: 'Clara', text: 'We measured oxygen transmission rates over a 14-day storage trial with fresh strawberries at 4 degrees Celsius.' },
          { speaker: 'David', text: 'The results showed fruit spoiled within 5 days in standard plastic, but survived fresh for 12 days inside the chitosan pouch.' },
          { speaker: 'Prof. Lin', text: 'Fascinating. Be sure to present your statistical analysis at the department symposium next Wednesday.' }
        ],
        questions: [
          {
            id: 11,
      ...
      },
      {
        ...
        transcript: [
          { speaker: 'Lecturer', text: 'In today\'s lecture on chronobiology, we examine the master circadian pacemaker: the suprachiasmatic nucleus, or SCN.' },
          { speaker: 'Lecturer', text: 'Specialized intrinsically photosensitive retinal ganglion cells detect blue light wavelengths specifically between 460 and 480 nanometers.' },
          ...
          { speaker: 'Lecturer', text: 'In adolescents, a physiological phase delay naturally shifts the biological clock approximately two hours later than in adults.' },
          { speaker: 'Lecturer', text: 'School districts that instituted a 45-minute later morning start time documented a 15 percent drop in teenage automobile accidents.' }
        ],
        questions: [
          {
            id: 16,
    ...
    sections: [
      {
        ...
        transcript: [
          ...
          { speaker: 'Customer', text: 'I will take the Premium Cover. Can I also request a child seat?' },
          { speaker: 'Agent', text: 'Yes, child booster seats are 5 pounds flat fee per rental.' },
          { speaker: 'Customer', text: 'Great. Please confirm pickup time at 09:30 on Friday.' }
        ],
        questions: [
          {
            id: 1,
      ...
      },
      {
        ...
        transcript: [
          { speaker: 'Coordinator', text: 'A warm welcome to the Royal Playhouse Theatre volunteer induction. Built in 1892, our auditorium seats 850 patrons.' },
          { speaker: 'Coordinator', text: 'Our volunteer team handles two primary areas: Front-of-House stewarding and Backstage props management.' },
          { speaker: 'Coordinator', text: 'Front-of-house stewards must arrive 45 minutes prior to curtain call to distribute programmes and inspect emergency exits.' },
          { speaker: 'Coordinator', text: 'All volunteers receive complimentary tickets: for every 20 hours volunteered, you earn two complimentary dress-circle vouchers.' },
          { speaker: 'Coordinator', text: 'Our monthly volunteer briefing takes place on the first Monday of every month in the Green Room.' }
        ],
        questions: [
          {
            id: 6,
      ...
      },
      {
        ...
        transcript: [
          { speaker: 'Dr. Miller', text: 'Good morning Liam, Sophie. Let us look at your survey of the coral reef transects.' },
          { speaker: 'Liam', text: 'Thank you Dr. Miller. We analyzed scleractinian coral colonies subjected to sea surface temperature anomalies of plus 1.5 degrees Celsius.' },
          { speaker: 'Sophie', text: 'When heat stress triggers reactive oxygen species production, the coral polyps expel their symbiotic dinoflagellates, losing up to 90 percent of their photosynthetic energy source.' },
          { speaker: 'Dr. Miller', text: 'Did you observe any recovery in colonies that were shaded by local topography?' },
          { speaker: 'Liam', text: 'Yes, colonies in deep reef channels showed a 40 percent faster recovery rate compared to shallow reef crests.' },
          { speaker: 'Sophie', text: 'We plan to test whether micro-fragmentation accelerates calcification in our follow-up experiment.' }
        ],
        questions: [
          {
            id: 10,
      ...
      },
      {
        ...
        transcript: [
          { speaker: 'Lecturer', text: 'Good afternoon. Today we examine subterranean flint mining during the British Neolithic period, dating to roughly 3000 BCE.' },
          { speaker: 'Lecturer', text: 'The most renowned site is Grime\'s Graves in Norfolk, comprising over 400 vertical shafts sunk into the chalk beds.' },
          { speaker: 'Lecturer', text: 'Prehistoric miners excavated downward to depths of up to 12 metres using picks made exclusively from red deer antlers.' },
          { speaker: 'Lecturer', text: 'They specifically targeted the deepest layer of high-grade black flint, known as floorstone, valued for crafting durable axe heads.' },
          { speaker: 'Lecturer', text: 'Geochemical trace-element sourcing shows these finished flint axes were traded across distances exceeding 300 kilometers.' }
        ],
        questions: [
          {
            id: 13,
    ...
    sections: [
      {
        ...
        transcript: [
          ...
          { speaker: 'Parent', text: 'Is there a minimum target of books to read?' },
          { speaker: 'Librarian', text: 'Yes, participants aim to finish 6 books over the six-week holiday.' },
          { speaker: 'Parent', text: 'Do they receive a medal at the end?' },
          { speaker: 'Librarian', text: 'Every child completing the challenge receives a bronze certificate and a reading badge.' }
        ],
        questions: [
          {
            id: 1,
      ...
      },
      {
        ...
        transcript: [
          { speaker: 'Ranger Alan', text: 'Good morning hikers. Ben Nevis stands at 1,345 metres above sea level, making it the highest summit in the British Isles.' },
          { speaker: 'Ranger Alan', text: 'Even in mid-summer, summit temperatures regularly plunge to freezing, and summit visibility can drop below 10 metres within minutes.' },
          { speaker: 'Ranger Alan', text: 'Sturdy ankle-supporting boots are compulsory; trainers are strictly prohibited on scree slopes.' },
          { speaker: 'Ranger Alan', text: 'The mountain rescue emergency box is stationed near the Halfway Lake, containing thermal foil blankets and first aid splints.' },
          { speaker: 'Ranger Alan', text: 'Please ensure you register your planned descent time at the visitor center before commencing.' }
        ],
        questions: [
          {
            id: 5,
      ...
      },
      {
        ...
        transcript: [
          { speaker: 'Prof. Henderson', text: 'Elena, Tariq, let us review your feasibility study on coastal desalination technologies.' },
          { speaker: 'Elena', text: 'Thank you Professor. Our analysis confirms reverse osmosis uses approximately 3 kilowatt-hours of electricity per cubic metre of potable water.' },
          { speaker: 'Tariq', text: 'This represents a 70 percent energy reduction compared to traditional multi-stage flash distillation.' },
          { speaker: 'Prof. Henderson', text: 'Indeed. But what mitigation strategy did you formulate for the hypersaline brine effluent discharged back into the sea?' },
          { speaker: 'Elena', text: 'We propose multi-port submarine diffusers situated 500 metres offshore to dilute salinity within 50 metres of discharge.' },
          { speaker: 'Tariq', text: 'We also modeled mineral extraction of lithium and magnesium from the concentrated brine to offset operational costs.' }
        ],
        questions: [
          {
            id: 8,
      ...
      },
      {
        ...
        transcript: [
          { speaker: 'Lecturer', text: 'Welcome back. Today we examine urban heat islands and the biological mitigation provided by urban forestry.' },
          { speaker: 'Lecturer', text: 'Impervious dark asphalt surfaces absorb up to 95 percent of incident solar radiation, elevating city core temperatures by 4 to 7 degrees Celsius.' },
          { speaker: 'Lecturer', text: 'Deciduous street trees alleviate this through two mechanisms: direct shade interception and evaporative transpiration.' },
          { speaker: 'Lecturer', text: 'A single mature beech tree can transpire upwards of 400 litres of water into the atmosphere on a hot summer afternoon.' },
          { speaker: 'Lecturer', text: 'Thermal infrared satellite data proves that continuous tree canopy cover reduces ambient asphalt surface temperatures by as much as 12 degrees.' }
        ],
        questions: [
          {
            id: 11,
  ...
  // ==========================================
  // TEST 5: 2025/2026 CDI RECENT RECALL
  // ==========================================
  {
    ...
    sections: [
      {
        ...
        transcript: [
          { speaker: 'Dispatcher', text: 'Heathrow Student Express, bookings desk. How can I assist?' },
          { speaker: 'Student', text: 'Good morning. I arrive on flight BA 184 on October 3rd and need an electric shuttle to Kings Cross student hall.' },
          { speaker: 'Dispatcher', text: 'Understood. What is your scheduled flight arrival time?' },
          ...
          { speaker: 'Student', text: 'How much luggage can I bring without extra surcharge?' },
          { speaker: 'Dispatcher', text: 'The standard ticket permits two large suitcases up to 23 kilograms each plus one cabin backpack.' },
          { speaker: 'Student', text: 'What is the total one-way fare?' },
          { speaker: 'Dispatcher', text: 'The student discounted fare is 28 pounds.' }
        ],
        questions: [
          {
            id: 1,
      ...
      },
      {
        ...
        transcript: [
          { speaker: 'Curator', text: 'Welcome visitors to the National Smart City Museum. Our building itself is net-zero, powered by 1,200 rooftop photovoltaic panels.' },
          { speaker: 'Curator', text: 'On the ground floor, Pavilion A showcases smart grid energy storage where visitors can simulate balancing city power demand.' },
          { speaker: 'Curator', text: 'If you wish to store backpacks, digital lockers are situated adjacent to the gift shop and accept contactless payment of £1.' },
          { speaker: 'Curator', text: 'Our flagship VR Urban Simulator on the second floor requires timed tickets, with time slots commencing every 20 minutes.' },
          { speaker: 'Curator', text: 'Please remember that flash photography is prohibited inside the Quantum Computing gallery to avoid sensor interference.' }
        ],
        questions: [
          {
            id: 5,
      ...
      },
      {
        ...
        transcript: [
          { speaker: 'Dr. Hughes', text: 'Come in Chen. How did the pilot deployment of Level 4 autonomous electric shuttles perform?' },
          { speaker: 'Chen', text: 'Dr. Hughes, the six shuttles completed over 15,000 kilometres on dedicated bus rapid transit corridors with zero collision incidents.' },
          { speaker: 'Dr. Hughes', text: 'What did the post-journey commuter survey reveal about public confidence?' },
          { speaker: 'Chen', text: 'Interestingly, 82 percent of passengers reported feeling as safe as riding in a conventional human-driven bus.' },
          { speaker: 'Dr. Hughes', text: 'Did the optical LiDAR sensors face difficulties during adverse weather?' },
          { speaker: 'Chen', text: 'Yes, heavy snowfall and dense fog caused a 14 percent reduction in maximum operating speed for safety compliance.' },
          { speaker: 'Dr. Hughes', text: 'Make sure your thesis includes the radar sensor fusion recommendations in chapter five.' }
        ],
        questions: [
          {
            id: 9,
      ...
      },
      {
        ...
        transcript: [
          { speaker: 'Lecturer', text: 'Good afternoon. Today we turn our focus to particles smaller than 100 nanometres in diameter: nanoplastics.' },
          { speaker: 'Lecturer', text: 'Unlike microplastics which remain largely inside digestive tracts, nanoplastics possess sufficient surface charge to penetrate cell membranes directly.' },
          { speaker: 'Lecturer', text: 'In laboratory trials with marine zooplankton, nanoplastics were absorbed into lipid tissue within just 30 minutes of exposure.' },
          { speaker: 'Lecturer', text: 'When these zooplankton were consumed by small pelagic fish, plastic molecules crossed the blood-brain barrier in 68 percent of tested specimens.' },
          { speaker: 'Lecturer', text: 'This evidence confirms trophic transfer, demonstrating that synthetic polymers bioaccumulate up the marine food chain into apex predators.' }
        ],
        questions: [
          {
            id: 12,
...
const fileContent = `import { ListeningTest } from '../types/ielts';\n\nexport const LISTENING_TESTS: ListeningTest[] = ` + JSON.stringify(tests, null, 2) + `;\n`;

fs.writeFileSync(dest, fileContent, 'utf8');
console.log('Successfully wrote', tests.length, 'listening tests with 4 full sections to', dest);
