      ...
      <div className="relative z-10 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="space-y-1.5">
            <div className="flex items-center gap-2 text-xs font-semibold tracking-wide text-[#86868b]">
              <Brain className="w-4 h-4 text-[#0071e3]" />
              <span className="uppercase tracking-wider">Ebbinghaus Memory Engine</span>
          ...
          <div className="flex items-center gap-2.5 self-start sm:self-auto shrink-0">
            <button
              ...
              className="px-4 py-2 rounded-full bg-[#f5f5f7] hover:bg-[#e8e8ed] text-[#1d1d1f] text-xs font-medium border border-black/[0.04] transition-all flex items-center gap-1.5 cursor-pointer"
            >
            ...
            <button
              ...
              className="px-5 py-2 rounded-full bg-[#0071e3] hover:bg-[#0077ed] text-white text-xs font-semibold transition-all shadow-sm flex items-center gap-1.5 active:scale-98 cursor-pointer"
            >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3.5">
          <div className="bg-[#f5f5f7] rounded-2xl p-4 border border-black/[0.02]">
            ...
            <div className="text-[11px] text-[#86868b] mt-1 font-normal">
        ...
        <div className="bg-[#fbfbfd] border border-black/[0.04] rounded-2xl p-4 sm:p-5">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between text-xs mb-3 gap-2">
            <div className="flex items-center gap-2 font-medium text-[#1d1d1f]">
              ...
              <span className="text-[#86868b] font-normal">· 7个黄金突触强化节点</span>
            </div>
            <div className="flex items-center gap-4 text-[11px]">
              ...
              <span className="flex items-center gap-1.5 text-[#ff3b30] font-normal">
                <span className="w-2 h-0.5 bg-[#ff3b30] inline-block border-b border-dashed"></span>
                自然衰减遗忘 (跌至21%)
              </span>
            </div>
          </div>
        ...
        {showStageBreakdown && (
          <div className="bg-[#f5f5f7] border border-black/[0.04] rounded-2xl p-4 space-y-3 animate-fadeIn">
            <div className="flex items-center justify-between text-xs font-semibold text-[#1d1d1f]">
              ...
              <span className="text-[11px] text-[#86868b] font-normal">共计 {stats.totalItems} 条记忆锚点</span>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2.5">
              {stagesList.map(st => {
                ...
                return (
                  <div key={st} className="p-3 rounded-xl bg-white border border-black/[0.04] flex flex-col justify-between shadow-2xs">
                    <div>
                      ...
                      <p className="text-[10px] text-[#86868b] leading-snug">{desc.desc}</p>
                    </div>
                  </div>
                );
              })}
