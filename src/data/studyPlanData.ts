...
export const DEFAULT_PLAN_CONFIG: PersonalizedPlanConfig = {
  ...
  targetWriting: 6.5,
  targetSpeaking: 6.5,
  focusWeaknesses: ['词汇量不足2500', '长难句语法结构混乱', '听力连读与数字拼写反应慢', '写作句子单一片面']
};

export const STUDY_PHASES: StudyPlanPhase[] = [
  {
    id: 1,
    phaseNumber: 1,
    name: '筑基脱敏 · 核心词汇与基础语法重构',
    dayRange: 'Day 1 - 45',
    daysCount: 45,
    targetBand: 'Band 4.0 ➔ 5.0',
    subtitle: '扫清词汇死角与长难句障碍，攻克听力数字拼写基本盘',
    coreObjectives: [
  ...
  },
  {
    ...
    coreObjectives: [
      ...
      '实现目标分解：听力 7.5 + 阅读 7.5 + 写作 6.5 + 口语 6.5 = 总分 7.0！'
    ],
    ...
    keyMilestone: '全真机考连续 3 次模考总分均分稳定突破 7.0 分！自信走入真实雅思考场！'
  }
];
